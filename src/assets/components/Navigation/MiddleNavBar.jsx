    ...
    <>
      <div className='w-[100%] 2xl:h-[40px]  lg:h-8 bg-black flex justify-between fixed top-0 z-50 pb-2'>
        ...
        <div className='lg:block text-white flex justify-center items-center content-center  py-1 px-10 gap-12'>
          <Anchor to='/about' className='mx-2 2xl:text-lg lg:text-sm hover:underline'> About</Anchor>
          <Anchor to='/contact' className='mx-2 2xl:text-lg lg:text-sm  hover:underline'> Contact</Anchor>
          <Anchor to='/attendance' className='mx-2 2xl:text-lg lg:text-sm  hover:underline'> Attendance</Anchor>
